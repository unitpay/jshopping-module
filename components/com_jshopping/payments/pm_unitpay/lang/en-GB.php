...
define('_JSHOP_CFG_UNITPAY_PUBLIC_KEY_DESCRIPTION', 'Copy PUBLIC KEY from Unitpay.ru page');
define('_JSHOP_CFG_UNITPAY_SECRET_KEY', 'SECRET KEY');
define('_JSHOP_CFG_UNITPAY_SECRET_KEY_DESCRIPTION', 'Copy SECRET KEY from Unitpay.ru page');
